...
.result{font-size:24px;color:#00ff99;margin-top:15px;font-weight:bold}
</style>
...
max="100" 
step="0.01" 
placeholder="درجتك من 100"
oninput="limitGrade(this)"
>
</div>
{% endfor %}
...
<div class="result">نسبتك: {{total}}%</div>
{% endif %}
</div>
...
def images_to_pdf():
    ...
    return send_file(out, as_attachment=True, download_name="images.pdf")
